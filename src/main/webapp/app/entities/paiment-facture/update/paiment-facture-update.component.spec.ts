...
describe('PaimentFacture Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call ServiceClass query and add missing value', () => {
      ...
      const serviceClasses: IServiceClass[] = [{ id: 40186 }];
      paimentFacture.serviceClasses = serviceClasses;
      ...
      const additionalServiceClasses = [...serviceClasses];
    ...
    it('Should update editForm', () => {
      const paimentFacture: IPaimentFacture = { id: 456 };
      const serviceClasses: IServiceClass = { id: 53460 };
      paimentFacture.serviceClasses = [serviceClasses];
      ...
      expect(comp.serviceClassesSharedCollection).toContain(serviceClasses);
    });
  });
  ...
  describe('Getting selected relationships', () => {
    describe('getSelectedServiceClass', () => {
      it('Should return option if no ServiceClass is selected', () => {
        const option = { id: 123 };
        const result = comp.getSelectedServiceClass(option);
        expect(result === option).toEqual(true);
      });

      it('Should return selected ServiceClass for according option', () => {
        const option = { id: 123 };
        const selected = { id: 123 };
        const selected2 = { id: 456 };
        const result = comp.getSelectedServiceClass(option, [selected2, selected]);
        expect(result === selected).toEqual(true);
        expect(result === selected2).toEqual(false);
        expect(result === option).toEqual(false);
      });

      it('Should return option if this ServiceClass is not selected', () => {
        const option = { id: 123 };
        const selected = { id: 456 };
        const result = comp.getSelectedServiceClass(option, [selected]);
        expect(result === option).toEqual(true);
